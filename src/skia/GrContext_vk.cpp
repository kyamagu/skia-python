...
py::enum_<VkFormat>(m, "VkFormat")
    ...
    .value("BEGIN_RANGE",                                    VkFormat::VK_FORMAT_BEGIN_RANGE)
    .value("END_RANGE",                                      VkFormat::VK_FORMAT_END_RANGE)
    .value("RANGE_SIZE",                                     VkFormat::VK_FORMAT_RANGE_SIZE)
...
py::enum_<VkImageLayout>(m, "VkImageLayout", py::arithmetic())
    ...
    .value("BEGIN_RANGE",                                    VkImageLayout::VK_IMAGE_LAYOUT_BEGIN_RANGE)
    .value("END_RANGE",                                      VkImageLayout::VK_IMAGE_LAYOUT_END_RANGE)
    .value("RANGE_SIZE",                                     VkImageLayout::VK_IMAGE_LAYOUT_RANGE_SIZE)
